        ...
        element-loading-spinner="el-icon-loading">
            <div class="print-item" v-for="(item,index) of tableData" :key="index" 
                :id="'printDiv' + index" style="page-break-after:always; margin-top:5px">
                 <div class="print-item-content" style="font-size: 14px">
                    <div class="item-row" style="display:flex; align-items: center;">
                        <div class="item-row-left">订单</div>
                        <div class="item-row-right" style="margin-left:10px">{{item.omsOrder.orderNo}}</div>
                    </div>
...
<script>
import { orderPrint, orderPrints } from "@/api/module/production/oms/order/order";
export default {
  name: "orderPrints",
  props: {
    value: {
