<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="roleList" @selection-change="handleSelectionChange">
      ...
      <el-table-column :show-overflow-tooltip="true" label="行业" prop="roleKey" width="150"/>
      <el-table-column :show-overflow-tooltip="true" label="注册地区" prop="roleKey" width="150"/>
