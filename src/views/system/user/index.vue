    ...
    <el-row :gutter="20">
      ...
      <el-col :span="20" :xs="24">
        ...
        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
          ...
          <el-table-column v-if="columns[7].visible" key="jobNumber" :show-overflow-tooltip="true" align="center"
                           label="工号" prop="jobNumber"/>
          <el-table-column v-if="columns[8].visible" key="roles" :show-overflow-tooltip="true" align="center"
                           label="角色" prop="roles">
            <template slot-scope="scope">
              <div v-for="role in scope.row.roles" :key="role.roleKey">
                {{ role.roleName }}
              </div>
            </template>
          </el-table-column>
          ...
          <el-row>
            ...
            <el-col :span="12">
              <el-form-item label="角色">
                <el-select v-model="form.roleIds" :disabled="form.adminFlag === '1' && form.roleIds !== undefined && form.roleIds.length !== 0 " multiple placeholder="请选择">
                  <el-option
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="工号" prop="jobNumber">
                <el-input v-model="form.jobNumber" placeholder="请输入用户工号" />
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
