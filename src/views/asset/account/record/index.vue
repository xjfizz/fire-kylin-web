<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="交易创建时间" prop="transactionCreateTime">
        <el-date-picker clearable size="small"
          v-model="queryParams.transactionCreateTime"
          type="date"
      ...
      <el-form-item label="交易完成时间" prop="transactionCompleteTime">
        <el-date-picker clearable size="small"
          v-model="queryParams.transactionCompleteTime"
          type="date"
          value-format="yyyy-MM-dd"
      ...
      <el-form-item label="关联订单pkid" prop="relationOrderPkid">
        <el-input
          v-model="queryParams.relationOrderPkid"
          placeholder="请输入关联订单pkid"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="recordList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="交易创建时间" align="center" prop="transactionCreateTime" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.transactionCreateTime, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
      <el-table-column label="交易完成时间" align="center" prop="transactionCompleteTime" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.transactionCompleteTime, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
      <el-table-column label="关联订单pkid" align="center" prop="relationOrderPkid" />
      <el-table-column label="关联订单编号" align="center" prop="relationOrderNo" />
      <el-table-column label="交易流水编号" align="center" prop="transactionNo" />
