...
let produceApi = {
  ...
  getObtainTabList:(params)=> {
    return request({
      url: '/wkp/proxy/home/info/obtainTabData',
      method: 'get',
      params: params
    })
  },
  ...
  getObtainOrderTabList:(params)=> {
      return request({
      url: '/wkp/proxy/home/info/obtainOrderTabData',
      method: 'get',
      params: params
    })
  },
   ...
   getObtainProduceTabList:(params)=> {
    return request({
    url: '/wkp/proxy/home/info/obtainProductionCapacityTabData',
    method: 'get',
    params: params
  })
},
  ...
  getObtainIncomeTabList:(params)=> {
    return request({
    url: '/wkp/proxy/home/info/obtainIncomeTabData',
    method: 'get',
    params: params
  })
},
  ...
  getObtainUserTabList:(params)=> {
    return request({
    url: '/wkp/proxy/home/info/obtainUserTabData',
    method: 'get',
    params: params
  })
},
